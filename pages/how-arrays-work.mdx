...
<ArrayGrid arr={[8, 10, 7, 9, 12, 3, 4, 5]} />

An array represents a list of items. Arrays have fast lookup, meaning if you know the index of the item you're looking for, you can find the item in the array pretty quickly.

<ArrayLookup arr={[8, 10, 7, 9, 12, 3, 4, 5]} activeIndex={3} />
...
<ArrayGrid arr={[8, false, 'hello', 9]} />

But how does this all work? What's going on "under the hood" when you lookup an item in an array? What makes that operation so fast?
